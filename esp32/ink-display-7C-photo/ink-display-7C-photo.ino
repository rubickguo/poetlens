...
// =======================
#define DAILY_PHOTO_PATH_PREFIX "/static/poetlens/yourdownloadkey/photo_"
...
String buildConfigPage() {
  ...
  html += F("<title>poetlens 设置</title></head><body>");
  html += F("<h2>poetlens 设置</h2>");
...
void startConfigPortal() {
  ...
  String apSsid     = "poetlens-" + String((uint32_t)ESP.getEfuseMac(), HEX).substring(4);
...
#if DEBUG_LOG
  DBG_PRINTLN();
  DBG_PRINTLN("===== ESP32-S3 poetlens Daily Photo boot =====");
#endif
